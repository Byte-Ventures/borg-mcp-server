...
The current public preview is `borgmcp-server@0.1.12`, published on npm.
...
Current source is the unpublished `borgmcp-server@0.1.13` release candidate,
...
Version `0.1.12` completed a fresh exact-source, tagged-artifact, tokenless OIDC
