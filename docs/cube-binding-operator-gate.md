...
- Network access to the npm registry. The harness installs `borgmcp@2.10.2` at runtime; no client package, invitation, credential, or private key is checked into this repository.
