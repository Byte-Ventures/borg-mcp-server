...
The immutable annotated `v0.1.16` tag object
`e7f1bb84a0e011f5aa5a781b1d65179b4d15f975` peels to protected-main merge
`325f4c80b8ca7e885e6243762d1818d00ecf332d`. Workflow run `30019803768`, attempt 1,
built, published, and registry-verified the exact reviewed artifact. npm reports integrity
`sha512-P+xQVnmrSfQ5AzSoPKGo1H20lpyEEfBt8fEBVutKmeaBt0RbQFgGuYZk5WDbb9ACzQ/95wICTecPBAUQUq4fYA==`
and `latest` resolves to `0.1.16`. The tokenless OIDC publication and postpublication checks
verified registry integrity and ownership, provenance, signatures, and the Trusted Publishing
attestation.
...
The immutable annotated `v0.1.20` tag object
`910b245765bed4d5559afbfec8d3ede604c5a840` peels to protected-main commit
`8c5ae538f7ebabac1a024943cc18592f0ef3b557`. Workflow run `30126520456`,
