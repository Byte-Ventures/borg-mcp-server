...
const DEBUG_ROUTES: readonly DebugRoute[] = ["health", "protocol", "runtime", "enrollment_exchange", "client_attach", "repository_cube_resolve", "repository_cube_association", "cubes", "cube", "cube_roles", "cube_role", "cube_role_section_patch", "cube_taxonomy_patch", "cube_drones", "cube_drone_self_metadata", "cube_logs", "cube_ack_status", "cube_acks", "cube_decisions", "cube_documents", "cube_stream", "unknown"];
