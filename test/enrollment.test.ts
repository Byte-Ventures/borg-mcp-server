...
describe("enrollment wire adapter", () => {
  ...
  it.each([
    { protocol_version: "7", request_id: "request-1234", payload: { invitation: "weak" } },
     { protocol_version: "7", request_id: "bad", payload },
     { protocol_version: "7", request_id: "request-1234", payload: { ...payload, secret: invitation } },
