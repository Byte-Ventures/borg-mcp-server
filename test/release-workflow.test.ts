...
describe("server release lane", () => {
  ...
  it("documents the minimal lane and every immutable release boundary", async () => {
    ...
    for (const gate of [
      ...
      "live `borgmcp-server@0.1.14` package",
      "Version `0.1.14` remains the install target",
      "`borgmcp-server@0.1.15` candidate",
      "generic platform Queen/default two-role seed",
      "not full shared-template adoption",
