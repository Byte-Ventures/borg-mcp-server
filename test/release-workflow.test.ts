...
describe("server release lane", () => {
  ...
  it("documents the minimal lane and every immutable release boundary", async () => {
    ...
    for (const gate of [
      ...
      "`v0.1.17` tag object",
      "47ce3bcfa6784bc8dcbd00f47e796732188e5601",
      "b3e844560304fb9fbece2f4c0013ca2a2fbe1d64",
      "30059881193",
      "sha512-riacxQ+OFbP1hK7SsHUcKX+NpDWx9Ts1QlwkqCrzGcK5NGx3qfzP54rOpiXIpkktI/hnR3VgZziqpw3YbZoY5A==",
      "`v0.1.18` tag object",
      "e676d7524d622aa931727e9522f01ac7c27330b4",
      "0b5e1fc94314aa76e85daf5b4d24915523a963e5",
      "30073844139",
      "sha512-hr5lU8hNQ+ZTL1C9td/lhuCLY9X8pSEzZIo3tJ7UheS7Tun0y1J+XPQGW35UDhpgIIYJdjcT9iyGpzPF/CVRug==",
      "live `borgmcp-server@0.5.0` package",
      "Version `0.5.0` is the current install target",
      "`v0.1.19` tag object",
      "8f0fd01a4b5b8d03525282d72f025028e59c298c",
      "07f2abead5c9e196326da13183514f17cc43810b",
      "30106996572",
      "89526733696",
      "89526869244",
      "`v0.1.20` tag object",
      "910b245765bed4d5559afbfec8d3ede604c5a840",
      "8c5ae538f7ebabac1a024943cc18592f0ef3b557",
      "30126520456",
      "sha512-ycI02wlgG3dV9OsDDR9nXsqOppiYv4qFhTBMR6Nmdsc3lrt/1tHgU0JCPnfReriIs7CaSen8XHb8jigfnpE3dg==",
      "`v0.1.21` tag object",
      "d30037f0d13f752443d126b03fd81c063740bc6b",
      "ecffe95f73dc6a767c07c774a7a8192cb64ea8c5",
      "30171059501",
      "sha512-g0QH4cKcsKuDyZs1MvBmvCoCLaZ4wVI04yHCGSvcAeWghWxSBH0IIF8Q5OFi1pLB7TZXOVP6D3QAabUQ2eJTFg==",
      "`v0.2.0` tag object",
      "a62f645ced8d5e58620727f1bd20e5bb0ea61252",
      "119bfc5d341b4d68efcb3f0466be7cb75c7966ee",
      "30194326366",
      "sha512-squb0+vdy0q7l/4FeV7OTvSm7OiFWGsAjGhcVEXYrQc9K/8jJYduqPS90VBwaJRT6z221Gxf3xQ5SeZe/Qoncw==",
      "`v0.3.0` tag object",
      "0931d69e8c8b1bff24215a58bdd63ec6a207ff66",
      "23ad0e22d62e7fcdaa6962a6d69885193cf59a6e",
      "30206708486",
      "sha512-DqaTPHNdO9cvLEXsGFugDsyLlvsxNYEvNTdHUHIV6GguvKrYVXPi95BZyneHAyp04cPHlcFmy9MLupZW7dZwCw==",
      "`v0.4.0` tag object",
      "6fdcd88cb3548a3eaf767b0a3810727b67e72c83",
      "e4b6208c010d6d3e63f1f1b598bbf8c0ed9234a3",
      "30217101457",
      "sha512-MIDnrX9bYbfXmXZZnnbD52U6+GDF8tsorauVEYK9PVf/c5TI5KDL+uFff8jV5YRDQ4pzsHxAfTm2S+OlSvxhAg==",
      "`v0.5.0` tag object",
      "f366c02ab1dc5e50cb12c9f6db3f1d9642c0c244",
      "87d16e903760e31eedd1b182732b5ff3fd52145c",
      "30268303844",
      "sha512-6MWqD/56W7g4uXE8UdPuss52QWAjBOh/3PkGMmz5SI5YC4u6Sbn8EFFd9jo3KE4/gGq9ZSLu+aAIRHKGoV6aEQ==",
      "Source-lock verification performs no network access",
      "truthful advisory Agent CLI",
      "working-repository seat metadata",
      "explicit Queen activation timing contract",
      "structured, safe role-section conflict",
      "borgmcp-shared@0.6.4",
      "live protocol-v5 package",
      "mutation-free authoritative repository resolve",
