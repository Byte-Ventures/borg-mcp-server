...
describe("server release lane", () => {
  ...
  it("documents the minimal lane and every immutable release boundary", async () => {
    ...
    for (const gate of [
      ...
      "live `borgmcp-server@0.1.18` package",
      "Version `0.1.18` remains the install target",
      "`v0.1.19` tag object",
      ...
      "89526733696",
      "89526869244",
      "`borgmcp-server@0.1.20` recovery candidate",
      ...
      "protocol-v4 candidate atomically creates or resolves",
