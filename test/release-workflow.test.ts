...
describe("server release lane", () => {
  ...
  it("documents the minimal lane and every immutable release boundary", async () => {
    ...
    for (const gate of [
      ...
      "live `borgmcp-server@0.1.21` package",
      "Version `0.1.21` remains the install target",
      "`v0.1.19` tag object",
      ...
      "`borgmcp-server@0.2.0` release candidate",
      ...
      "static foreground dashboard",
      "operator-local read-only `dashboard` subcommand",
